...
bounds = {'/jointset/groundPelvis/pelvis_tilt/value', [0*pi/180, 50*pi/180], 43.426*pi/180, 0; ...
    '/jointset/groundPelvis/pelvis_tx/value', 2*[0, 0.5], 0.05, []; ...
    '/jointset/groundPelvis/pelvis_ty/value', [0, 1.0], 0.535, []; ...
    '/jointset/hip_l/hip_flexion_l/value', 2*[-15*pi/180, 80*pi/180], 48.858*pi/180, 0; ...
    '/jointset/hip_r/hip_flexion_r/value', 2*[-15*pi/180, 80*pi/180], 48.858*pi/180, 0; ...
    '/jointset/knee_l/knee_angle_l/value', 2*[-120*pi/180, 5*pi/180], -112.113*pi/180, 0; ...
    '/jointset/knee_r/knee_angle_r/value', 2*[-120*pi/180, 5*pi/180], -112.113*pi/180, 0; ...
    '/jointset/ankle_l/ankle_angle_l/value', 2*[0*pi/180, 35*pi/180], 21.109*pi/180, 0; ...
    '/jointset/ankle_r/ankle_angle_r/value', 2*[0*pi/180, 35*pi/180], 21.109*pi/180, 0; ...
    '/jointset/lumbar/lumbar/value', 2*[-70*pi/180, 0*pi/180], -53.183*pi/180, 0; ...
    '/jointset/groundPelvis/pelvis_tilt/speed', 10*[-150, 150]*pi/180, 0, 0; ...
    '/jointset/groundPelvis/pelvis_tx/speed', 10*[-0.5, 0.5], 0, 0; ...
    '/jointset/groundPelvis/pelvis_ty/speed', 10*[-0.2, 1], 0, 0; ...
    '/jointset/hip_l/hip_flexion_l/speed', 10*[-250, 150]*pi/180, 0, 0; ...
    '/jointset/hip_r/hip_flexion_r/speed', 10*[-250, 150]*pi/180, 0, 0; ...
    '/jointset/knee_l/knee_angle_l/speed', 10*[-50, 300]*pi/180, 0, 0; ...
    '/jointset/knee_r/knee_angle_r/speed', 10*[-50, 300]*pi/180, 0, 0; ...
    '/jointset/ankle_l/ankle_angle_l/speed', 10*[-120, 80]*pi/180, 0, 0; ...
    '/jointset/ankle_r/ankle_angle_r/speed', 10*[-120, 80]*pi/180, 0, 0; ...
    '/jointset/lumbar/lumbar/speed', 10*[-100, 200]*pi/180, 0, 0};
...
if exist(settings_savepath, 'file')
    ...
    settings = struct('input_model', input_model, ...
        ...
        'p_effort', p_effort, 'p_translation', p_translation);
...
function [general, predictive] = compareSettings(one, two)
    ...
    predictive = all([...
        ...
        one.p_translation == two.p_translation]);
