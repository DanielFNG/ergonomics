...
problem.setStateInfo('/jointset/knee_l/knee_angle_l/value', [-120*pi/180, 5], -109.565*pi/180, 0);
problem.setStateInfo('/jointset/knee_r/knee_angle_r/value', [-120*pi/180, 5], -109.565*pi/180, 0);
