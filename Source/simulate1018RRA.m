function simulate1018RRA(osim_model, controls, states, actuators, loads, save_path)
    ...
    osim.addForce(TorqueActuator.safeDownCast(force_set.get(2)));
    for i = 3:force_set.getSize() - 1
    ...
    % Simulate
    for i = 1:500%length(actuator_controls.Timesteps)
