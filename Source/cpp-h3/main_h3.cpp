...
int main() {
    ...
    std::string input_model = "h3_moco_2d.osim";
    ...
    std::string output_path = "mos_h3.sto";
    double w_effort = 0.1;
    ...
    using SimTK::Pi;
    problem.setStateInfo("/jointset/ground_H3_back/H3_back_tilt/value", 
        {-50*Pi/180, 50*Pi/180}, 0*Pi/180, 0);
    problem.setStateInfo("/jointset/ground_H3_back/H3_back_tx/value", 
        {0, 0.5}, 0.05);
    problem.setStateInfo("/jointset/ground_H3_back/H3_back_ty/value", 
        {0.5, 1.0}, 0.520);
    problem.setStateInfo("/jointset/hip_l/hip_flexion_l/value", 
        {-15*Pi/180, 100*Pi/180}, 90*Pi/180, 0);
    problem.setStateInfo("/jointset/hip_r/hip_flexion_r/value", 
        {-15*Pi/180, 100*Pi/180}, 90*Pi/180, 0);
    problem.setStateInfo("/jointset/knee_l/knee_angle_l/value", 
        {-120*Pi/180, 5*Pi/180}, -90*Pi/180, 0);
    problem.setStateInfo("/jointset/knee_r/knee_angle_r/value", 
        {-120*Pi/180, 5*Pi/180}, -90*Pi/180, 0);
    problem.setStateInfo("/jointset/ankle_l/ankle_angle_l/value", 
        {0*Pi/180, 35*Pi/180}, 10*Pi/180, 0);
