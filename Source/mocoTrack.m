...
tableProcessor = TableProcessor('squat_reference_states_moco.sto');
% tableProcessor.append(TabOpLowPassFilter(6)); % Not needed as using RRA
% data
...
%track.set_track_reference_position_derivatives(true); % not needed as
%states includes speeds 
track.set_apply_tracked_states_to_guess(true);
track.set_initial_time(18);
%track.set_final_time(19);
...
% Bounds
% ======
reference = Data('squat_reference_moco.sto');
problem.setStateInfo('/jointset/groundPelvis/pelvis_tilt/value', [-15*pi/180, 10*pi/180], reference.getValue(1, '/jointset/groundPelvis/pelvis_tilt/value'));
problem.setStateInfo('/jointset/groundPelvis/pelvis_tx/value', [-1, 1], reference.getValue(1, '/jointset/groundPelvis/pelvis_tx/value'));
problem.setStateInfo('/jointset/groundPelvis/pelvis_ty/value', [0.5, 1], reference.getValue(1, '/jointset/groundPelvis/pelvis_ty/value'));
problem.setStateInfo('/jointset/hip_l/hip_flexion_l/value', [-20*pi/180, 80*pi/180], reference.getValue(1, '/jointset/hip_l/hip_flexion_l/value'));
problem.setStateInfo('/jointset/hip_r/hip_flexion_r/value', [-20*pi/180, 80*pi/180], reference.getValue(1, '/jointset/hip_r/hip_flexion_r/value'));
problem.setStateInfo('/jointset/knee_l/knee_angle_l/value', [-110*pi/180, 10*pi/180], reference.getValue(1, '/jointset/knee_l/knee_angle_l/value'));
problem.setStateInfo('/jointset/knee_r/knee_angle_r/value', [-110*pi/180, 10*pi/180], reference.getValue(1, '/jointset/knee_r/knee_angle_r/value'));
problem.setStateInfo('/jointset/ankle_l/ankle_angle_l/value', [0*pi/180, 30*pi/180], reference.getValue(1, '/jointset/ankle_l/ankle_angle_l/value'));
problem.setStateInfo('/jointset/ankle_r/ankle_angle_r/value', [0*pi/180, 30*pi/180], reference.getValue(1, '/jointset/ankle_r/ankle_angle_r/value'));
problem.setStateInfo('/jointset/lumbar/lumbar/value', [-90*pi/180, 90*pi/180], reference.getValue(1, '/jointset/lumbar/lumbar/value'));
...
solver.setGuess(tracking_solution); % Use tracking solution as initial guess
